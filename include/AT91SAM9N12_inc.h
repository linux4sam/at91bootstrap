...
#define CCFG_EBICSA     (8)    //  EBI Chip Select Assignement Register
...
#define AT91C_CCFG_EBICSA         (0xFFFFDF18)  // (CCFG)  EBI Chip Select Assignement Register
