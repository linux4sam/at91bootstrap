...
#define SFLASH_PROTO_DTR_EN		(0x1UL << 24) 	/* Double Transfer Rate */
...
enum spi_flash_protocol {
	...
	SFLASH_PROTO_8D_8D_8D = SFLASH_PROTO_DTR(8, 8, 8),
#endif
};
...
{
	return ((proto & SFLASH_PROTO_DTR_EN) == SFLASH_PROTO_DTR_EN);
}
