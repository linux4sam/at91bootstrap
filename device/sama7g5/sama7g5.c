...
void at91_qspi_hw_init(void)
{
	...
	const struct pio_desc qspi_pins[] = {
		{"QSPI0_IO0", AT91C_PIN_PB(25), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
		{"QSPI0_IO1", AT91C_PIN_PB(24), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
		{"QSPI0_IO2", AT91C_PIN_PB(23), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
		{"QSPI0_IO3", AT91C_PIN_PB(22), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
		{"QSPI0_CS", AT91C_PIN_PB(26), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
		{"QSPI0_SCK", AT91C_PIN_PB(27), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
		{(char *)0, 0, 0, PIO_DEFAULT, PIO_PERIPH_A},
	};
#else
	const struct pio_desc qspi_pins[] = {
