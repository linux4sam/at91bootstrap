...
void at91_qspi_hw_init(void)
{
	...
	const struct pio_desc qspi_pins[] = {
		{"QSPI1_IO0", AT91C_PIN_PB(11), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
		{"QSPI1_IO1", AT91C_PIN_PB(10), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
		{"QSPI1_IO2", AT91C_PIN_PB(9), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
		{"QSPI1_IO3", AT91C_PIN_PB(8), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
		...
		{"QSPI1_CS", AT91C_PIN_PB(12), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
		{"QSPI1_SCK", AT91C_PIN_PB(13), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
...
#else
	const struct pio_desc qspi_pins[] = {
		{"QSPI0_IO0", AT91C_PIN_PB(15), 0, PIO_DRVSTR_HI, PIO_PERIPH_B},
		{"QSPI0_IO1", AT91C_PIN_PB(16), 0, PIO_DRVSTR_HI, PIO_PERIPH_B},
		{"QSPI0_IO2", AT91C_PIN_PB(17), 0, PIO_DRVSTR_HI, PIO_PERIPH_B},
		{"QSPI0_IO3", AT91C_PIN_PB(18), 0, PIO_DRVSTR_HI, PIO_PERIPH_B},
		{"QSPI0_CS", AT91C_PIN_PB(20), 0, PIO_DRVSTR_HI, PIO_PERIPH_B},
		{"QSPI0_SCK", AT91C_PIN_PB(14), 0, PIO_DRVSTR_HI, PIO_PERIPH_B},
		{(char *)0, 0, 0, PIO_DEFAULT, PIO_PERIPH_A},
	};
#endif
