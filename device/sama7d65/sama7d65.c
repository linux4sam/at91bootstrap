...
static void at91_dbgu_hw_init(void)
{
	const struct pio_desc dbgu_pins[] = {
		...
		{"FLX_IO0", AT91C_PIN_PA(12), 0, PIO_DEFAULT, PIO_PERIPH_B},
		{"FLX_IO1", AT91C_PIN_PA(13), 0, PIO_DEFAULT, PIO_PERIPH_B},
	#elif CONFIG_CONSOLE_INDEX == 1
		/* FLEXCOM0 IOSET 2 USART pins */
		{"FLX_IO0", AT91C_PIN_PC(7), 0, PIO_DEFAULT, PIO_PERIPH_D},
		{"FLX_IO1", AT91C_PIN_PC(6), 0, PIO_DEFAULT, PIO_PERIPH_D},
	#elif CONFIG_CONSOLE_INDEX == 2
		/* FLEXCOM1 IOSET 1 USART pins */
		{"FLX_IO0", AT91C_PIN_PD(7), 0, PIO_DEFAULT, PIO_PERIPH_B},
		{"FLX_IO1", AT91C_PIN_PD(6), 0, PIO_DEFAULT, PIO_PERIPH_B},
	#elif CONFIG_CONSOLE_INDEX == 3
		/* FLEXCOM1 IOSET 2 USART pins */
		{"FLX_IO0", AT91C_PIN_PC(14), 0, PIO_DEFAULT, PIO_PERIPH_C},
		{"FLX_IO1", AT91C_PIN_PC(15), 0, PIO_DEFAULT, PIO_PERIPH_C},
	#elif CONFIG_CONSOLE_INDEX == 4
		...
		{"FLX_IO0", AT91C_PIN_PA(14), 0, PIO_DEFAULT, PIO_PERIPH_C},
		{"FLX_IO1", AT91C_PIN_PA(15), 0, PIO_DEFAULT, PIO_PERIPH_C},
	#elif CONFIG_CONSOLE_INDEX == 13
...
static void initialize_serial(void)
{
	...
	at91_dbgu_hw_init();
	usart_init(BAUDRATE(APB_CLOCK, baudrate));
}
...
void at91_qspi_hw_init(void)
{
	...
	const struct pio_desc qspi_pins[] = {
		{"QSPI1_IO0", AT91C_PIN_PB(15), 0, PIO_DRVSTR_HI, PIO_PERIPH_B},
		{"QSPI1_IO1", AT91C_PIN_PB(16), 0, PIO_DRVSTR_HI, PIO_PERIPH_B},
		{"QSPI1_IO2", AT91C_PIN_PB(17), 0, PIO_DRVSTR_HI, PIO_PERIPH_B},
		{"QSPI1_IO3", AT91C_PIN_PB(18), 0, PIO_DRVSTR_HI, PIO_PERIPH_B},
		{"QSPI1_CS", AT91C_PIN_PB(20), 0, PIO_DRVSTR_HI, PIO_PERIPH_B},
		{"QSPI1_SCK", AT91C_PIN_PB(14), 0, PIO_DRVSTR_HI, PIO_PERIPH_B},
		{(char *)0, 0, 0, PIO_DEFAULT, PIO_PERIPH_A},
	};
#else
	const struct pio_desc qspi_pins[] = {
		{"QSPI0_IO0", AT91C_PIN_PB(11), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
		{"QSPI0_IO1", AT91C_PIN_PB(10), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
		{"QSPI0_IO2", AT91C_PIN_PB(9), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
		{"QSPI0_IO3", AT91C_PIN_PB(8), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
		{"QSPI0_IO4", AT91C_PIN_PB(15), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
		{"QSPI0_IO5", AT91C_PIN_PB(16), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
		{"QSPI0_IO6", AT91C_PIN_PB(17), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
		{"QSPI0_IO7", AT91C_PIN_PB(18), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
		{"QSPI0_CS", AT91C_PIN_PB(12), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
		{"QSPI0_SCK", AT91C_PIN_PB(13), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
		{"QSPI0_SCKN", AT91C_PIN_PB(14), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
		{"QSPI0_DQS", AT91C_PIN_PB(19), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
		{"QSPI0_INT", AT91C_PIN_PB(20), 0, PIO_DRVSTR_HI, PIO_PERIPH_A},
		{(char *)0, 0, 0, PIO_DEFAULT, PIO_PERIPH_A},
	};
#endif
...
void nandflash_set_smc_timing(unsigned int timing_mode)
{
    ...
    if (timing_mode == TIMING_MODE_3) {
		...
		writel(AT91C_SMC_SETUP_NWE(2), ATMEL_BASE_SMC + SMC_SETUP0);

		writel(AT91C_SMC_PULSE_NWE(4) | AT91C_SMC_PULSE_NCS_WR(7) |
			AT91C_SMC_PULSE_NRD(4) | AT91C_SMC_PULSE_NCS_RD(6),
			ATMEL_BASE_SMC + SMC_PULSE0);

		writel(AT91C_SMC_CYCLE_NWE(7) | AT91C_SMC_CYCLE_NRD(6),
			(ATMEL_BASE_SMC + SMC_CYCLE0));

		writel(AT91C_SMC_TIMINGS_TCLR(2) | AT91C_SMC_TIMINGS_TADL(15) |
			AT91C_SMC_TIMINGS_TAR(2) | AT91C_SMC_TIMINGS_TRR(4) |
		...
		writel(AT91C_SMC_MODE_READMODE_NRD_CTRL |
			...
			AT91C_SMC_MODE_TDF_CYCLES(15), ATMEL_BASE_SMC + SMC_MODE0);
	} else {
		/* Configure SMC CS3 for NAND */
		writel(AT91C_SMC_SETUP_NWE(4), ATMEL_BASE_SMC + SMC_SETUP0);
...
void nandflash_hw_init(void)
{
	const struct pio_desc nand_pins[] = {
		{"NANDOE", CONFIG_SYS_NAND_OE_PIN, 0, PIO_DEFAULT, PIO_PERIPH_C},
		{"NANDWE", CONFIG_SYS_NAND_WE_PIN, 0, PIO_DEFAULT, PIO_PERIPH_C},
		{"NANDALE", CONFIG_SYS_NAND_ALE_PIN, 0, PIO_DEFAULT, PIO_PERIPH_C},
		{"NANDCLE", CONFIG_SYS_NAND_CLE_PIN, 0, PIO_DEFAULT, PIO_PERIPH_C},
		{"NANDCS", CONFIG_SYS_NAND_ENABLE_PIN, 0, PIO_DEFAULT, PIO_OUTPUT},
		{"D0", AT91C_PIN_PA(3), 0, PIO_DEFAULT, PIO_PERIPH_C},
		{"D1", AT91C_PIN_PA(4), 0, PIO_DEFAULT, PIO_PERIPH_C},
		{"D2", AT91C_PIN_PA(9), 0, PIO_DEFAULT, PIO_PERIPH_C},
		{"D3", AT91C_PIN_PA(10), 0, PIO_DEFAULT, PIO_PERIPH_C},
		{"D4", AT91C_PIN_PA(5), 0, PIO_DEFAULT, PIO_PERIPH_C},
		{"D5", AT91C_PIN_PA(6), 0, PIO_DEFAULT, PIO_PERIPH_C},
		{"D6", AT91C_PIN_PA(7), 0, PIO_DEFAULT, PIO_PERIPH_C},
		{"D7", AT91C_PIN_PA(8), 0, PIO_DEFAULT, PIO_PERIPH_C},
		{(char *)0, 0, 0, PIO_DEFAULT, PIO_PERIPH_A},
	};
...
void at91_sdhc_hw_init(void)
{
	...
	const struct pio_desc sdmmc_pins[] = {
		{"SDMMC1_CK",   AT91C_PIN_PB(23), 0, PIO_DEFAULT, PIO_PERIPH_A},
		{"SDMMC1_CMD",  AT91C_PIN_PB(22), 0, PIO_PULLUP, PIO_PERIPH_A},
		{"SDMMC1_DAT0", AT91C_PIN_PB(24), 0, PIO_PULLUP, PIO_PERIPH_A},
		{"SDMMC1_DAT1", AT91C_PIN_PB(25), 0, PIO_PULLUP, PIO_PERIPH_A},
		{"SDMMC1_DAT2", AT91C_PIN_PB(26), 0, PIO_PULLUP, PIO_PERIPH_A},
		{"SDMMC1_DAT3", AT91C_PIN_PB(27), 0, PIO_PULLUP, PIO_PERIPH_A},
	...
	const struct pio_desc sdmmc_pins[] = {
		{"SDMMC2_CK",   AT91C_PIN_PC(28), 0, PIO_DEFAULT, PIO_PERIPH_A},
		{"SDMMC2_CMD",  AT91C_PIN_PC(27), 0, PIO_PULLUP, PIO_PERIPH_A},
		{"SDMMC2_DAT0", AT91C_PIN_PC(29), 0, PIO_PULLUP, PIO_PERIPH_A},
		{"SDMMC2_DAT1", AT91C_PIN_PC(30), 0, PIO_PULLUP, PIO_PERIPH_A},
		{"SDMMC2_DAT2", AT91C_PIN_PC(31), 0, PIO_PULLUP, PIO_PERIPH_A},
		{"SDMMC2_DAT3", AT91C_PIN_PD(0), 0, PIO_PULLUP, PIO_PERIPH_A},
...
void hw_preinit(void)
{
	...
	shdwc_disable_lpm();
	/*
	 * Out of Romcode, MCK1 and MCK5 - MCK9 are already configured with 
	 * SYSPLL at unwanted frequencies.
	 * We cannot reconfigure SYSPLL without first reconfiguring
	 * MCK1 & MCK5-MCK9 to different clock source.
	 * After we complete configuration for SYSPLL,
	 * we can configure MCK1 & MCK5-MCK9 accordingly
	 */
	...
	pmc_mck_cfg_set(5, BOARD_PRESCALER_MCK5_CLEAN,
			AT91C_MCR_DIV | AT91C_MCR_CSS | AT91C_MCR_EN);

	pmc_mck_cfg_set(6, BOARD_PRESCALER_MCK6_CLEAN,
			AT91C_MCR_DIV | AT91C_MCR_CSS | AT91C_MCR_EN);

	pmc_mck_cfg_set(7, BOARD_PRESCALER_MCK7_CLEAN,
			AT91C_MCR_DIV | AT91C_MCR_CSS | AT91C_MCR_EN);

	pmc_mck_cfg_set(8, BOARD_PRESCALER_MCK8_CLEAN,
			AT91C_MCR_DIV | AT91C_MCR_CSS | AT91C_MCR_EN);

	pmc_mck_cfg_set(9, BOARD_PRESCALER_MCK9_CLEAN,
			AT91C_MCR_DIV | AT91C_MCR_CSS | AT91C_MCR_EN);
	/*
	 * We are done here cleaning up MCK1 and MCK5-MCK9, so we can 
	 * configure SYSPLL at cruise speed
	 */
}
...
void hw_init(void)
{
	...
	pmc_mck_cfg_set(4, BOARD_PRESCALER_MCK4,
			AT91C_MCR_DIV | AT91C_MCR_CSS | AT91C_MCR_EN);
	/* MCK5 @ 200 Mhz (== SYSPLL/2) */
	pmc_mck_cfg_set(5, BOARD_PRESCALER_MCK5,
			AT91C_MCR_DIV | AT91C_MCR_CSS | AT91C_MCR_EN);
	/* MCK6 @ 200 Mhz (== SYSPLL/2) */
	pmc_mck_cfg_set(6, BOARD_PRESCALER_MCK6,
			AT91C_MCR_DIV | AT91C_MCR_CSS | AT91C_MCR_EN);
	/* MCK7 @ 100 Mhz (== SYSPLL/4) */
	pmc_mck_cfg_set(7, BOARD_PRESCALER_MCK7,
			AT91C_MCR_DIV | AT91C_MCR_CSS | AT91C_MCR_EN);
	/* MCK8 @ 100 Mhz (== SYSPLL/4) */
	pmc_mck_cfg_set(8, BOARD_PRESCALER_MCK8,
			AT91C_MCR_DIV | AT91C_MCR_CSS | AT91C_MCR_EN);
	/* MCK9 @ 100 Mhz (== SYSPLL/4) */
	pmc_mck_cfg_set(9, BOARD_PRESCALER_MCK9,
			AT91C_MCR_DIV | AT91C_MCR_CSS | AT91C_MCR_EN);
	...
	console_printf("UMCTL2: umctl2_config_state_init.\n");
