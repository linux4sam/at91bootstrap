...
ifeq ($(CONFIG_DBW_16),y)
CPPFLAGS += -DCONFIG_DBW_16
endif
ifeq ($(CONFIG_DBW_16_2),y)
CPPFLAGS += -DCONFIG_DBW_16_2
endif
ifeq ($(CONFIG_DBW_32),y)
CPPFLAGS += -DCONFIG_DBW_32
endif

ifeq ($(CONFIG_DDR_SET_BY_DEVICE),y)
CPPFLAGS += -DCONFIG_DDR_SET_BY_DEVICE
endif
ifeq ($(CONFIG_DDR_SET_JEDEC),y)
CPPFLAGS += -DCONFIG_DDR_SET_JEDEC
endif
ifeq ($(CONFIG_DDR_SET_BY_TIMING),y)
CPPFLAGS += -DCONFIG_DDR_SET_BY_TIMING
endif

ifeq ($(CONFIG_DDR_SET_BY_DEVICE),y)
ifeq ($(CONFIG_DDR_MT41K128M16_D2),y)
CPPFLAGS += -DCONFIG_DDR_MT41K128M16_D2
CPPFLAGS += -DCONFIG_DDR3
endif
ifeq ($(CONFIG_DDR_W972GG6KB_D2),y)
CPPFLAGS += -DCONFIG_DDR_W972GG6KB_D2
CPPFLAGS += -DCONFIG_DDR2
endif
ifeq ($(CONFIG_DDR_W972GG6KB_9X60),y)
CPPFLAGS += -DCONFIG_DDR_W972GG6KB_9X60
CPPFLAGS += -DCONFIG_DDR2
endif
ifeq ($(CONFIG_DDR_W971GG6SB_D2),y)
CPPFLAGS += -DCONFIG_DDR_W971GG6SB_D2
CPPFLAGS += -DCONFIG_DDR2
endif
ifeq ($(CONFIG_DDR_AD220032D),y)
CPPFLAGS += -DCONFIG_DDR_AD220032D
CPPFLAGS += -DCONFIG_LPDDR2
endif

endif

ifeq ($(CONFIG_DDR_64_MBIT),y)
CPPFLAGS += -DCONFIG_DDR_64_MBIT
endif
ifeq ($(CONFIG_DDR_128_MBIT),y)
CPPFLAGS += -DCONFIG_DDR_128_MBIT
endif
ifeq ($(CONFIG_DDR_256_MBIT),y)
CPPFLAGS += -DCONFIG_DDR_256_MBIT
endif
ifeq ($(CONFIG_DDR_512_MBIT),y)
CPPFLAGS += -DCONFIG_DDR_512_MBIT
endif
ifeq ($(CONFIG_DDR_1_GBIT),y)
CPPFLAGS += -DCONFIG_DDR_1_GBIT
endif
ifeq ($(CONFIG_DDR_2_GBIT),y)
CPPFLAGS += -DCONFIG_DDR_2_GBIT
endif
ifeq ($(CONFIG_DDR_4_GBIT),y)
CPPFLAGS += -DCONFIG_DDR_4_GBIT
endif

ifeq ($(CONFIG_BANK_4),y)
CPPFLAGS += -DCONFIG_BANK_4
endif
ifeq ($(CONFIG_BANK_8),y)
CPPFLAGS += -DCONFIG_BANK_8
endif

ifeq ($(CONFIG_CAS_2),y)
CPPFLAGS += -DCONFIG_CAS_2
endif
ifeq ($(CONFIG_CAS_3),y)
CPPFLAGS += -DCONFIG_CAS_3
endif
ifeq ($(CONFIG_CAS_5),y)
CPPFLAGS += -DCONFIG_CAS_5
endif
ifeq ($(CONFIG_CAS_6),y)
CPPFLAGS += -DCONFIG_CAS_6
endif

ifeq ($(CONFIG_DDR_SET_JEDEC),y)
ifeq ($(CONFIG_DDR_SPEED_200),y)
CPPFLAGS += -DCONFIG_DDR_SPEED_200
endif
ifeq ($(CONFIG_DDR_SPEED_200),y)
CPPFLAGS += -DCONFIG_DDR_SPEED_200
endif
ifeq ($(CONFIG_DDR_SPEED_266),y)
CPPFLAGS += -DCONFIG_DDR_SPEED_266
endif
ifeq ($(CONFIG_DDR_SPEED_333),y)
CPPFLAGS += -DCONFIG_DDR_SPEED_333
endif
ifeq ($(CONFIG_DDR_SPEED_370),y)
CPPFLAGS += -DCONFIG_DDR_SPEED_370
endif
ifeq ($(CONFIG_DDR_SPEED_400),y)
CPPFLAGS += -DCONFIG_DDR_SPEED_400
endif
ifeq ($(CONFIG_DDR_SPEED_533),y)
CPPFLAGS += -DCONFIG_DDR_SPEED_533
endif
ifeq ($(CONFIG_DDR_SPEED_667),y)
CPPFLAGS += -DCONFIG_DDR_SPEED_667
endif
ifeq ($(CONFIG_DDR_SPEED_800),y)
CPPFLAGS += -DCONFIG_DDR_SPEED_800
endif
ifeq ($(CONFIG_DDR_SPEED_1066),y)
CPPFLAGS += -DCONFIG_DDR_SPEED_1066
endif
ifeq ($(CONFIG_DDR_SPEED_1333),y)
CPPFLAGS += -DCONFIG_DDR_SPEED_1333
endif
...
ifeq ($(CONFIG_R14_C10),y)
CPPFLAGS += -DCONFIG_R14_C10
endif
ifeq ($(CONFIG_R13_C11),y)
CPPFLAGS += -DCONFIG_R13_C11
endif

ifeq ($(CONFIG_DDR_SET_BY_TIMING),y)
CPPFLAGS += \
	-DCONFIG_DDR_TRSA=$(CONFIG_DDR_TRSA) \
	-DCONFIG_DDR_TRCD=$(CONFIG_DDR_TRCD) \
	-DCONFIG_DDR_TWR=$(CONFIG_DDR_TWR) \
	-DCONFIG_DDR_TRC=$(CONFIG_DDR_TRC) \
	-DCONFIG_DDR_TRP=$(CONFIG_DDR_TRP) \
	-DCONFIG_DDR_TRRD=$(CONFIG_DDR_TRRD) \
	-DCONFIG_DDR_TWTR=$(CONFIG_DDR_TWTR) \
	-DCONFIG_DDR_TMRD=$(CONFIG_DDR_TMRD) \
	-DCONFIG_DDR_TRFC=$(CONFIG_DDR_TRFC) \
	-DCONFIG_DDR_TXSNR=$(CONFIG_DDR_TXSNR) \
	-DCONFIG_DDR_TXSRD=$(CONFIG_DDR_TXSRD) \
	-DCONFIG_DDR_TXP=$(CONFIG_DDR_TXP) \
	-DCONFIG_DDR_TXARD=$(CONFIG_DDR_TXARD) \
	-DCONFIG_DDR_TXARDS=$(CONFIG_DDR_TXARDS) \
	-DCONFIG_DDR_TRPA=$(CONFIG_DDR_TRPA) \
	-DCONFIG_DDR_TRTP=$(CONFIG_DDR_TRTP) \
	-DCONFIG_DDR_TFAW=$(CONFIG_DDR_TFAW)\
	-DCONFIG_DDR_RTC=$(CONFIG_DDR_RTC) 
endif
