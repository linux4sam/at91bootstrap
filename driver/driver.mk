...
COBJS-$(CONFIG_TRUSTZONE_SUPPORT)	+= $(DRIVERS_SRC)/at91_rstc.o
COBJS-$(CONFIG_TRUSTZONE_SUPPORT)	+= $(DRIVERS_SRC)/matrix.o
COBJS-$(CONFIG_TRUSTZONE_SUPPORT)	+= $(DRIVERS_SRC)/tz_utils.o
COBJS-$(CONFIG_TRUSTZONE_SUPPORT)	+= $(DRIVERS_SRC)/svc_handler.o
COBJS-$(CONFIG_TRUSTZONE_SUPPORT)	+= $(DRIVERS_SRC)/svc_mgr.o
COBJS-$(CONFIG_TRUSTZONE_SUPPORT)	+= $(DRIVERS_SRC)/lp310_l2cc.o
COBJS-$(CONFIG_TRUSTZONE_SUPPORT)	+= $(DRIVERS_SRC)/monitor/mon_init.o
COBJS-$(CONFIG_TRUSTZONE_SUPPORT)	+= $(DRIVERS_SRC)/monitor/mon_switch.o
COBJS-$(CONFIG_TRUSTZONE_SUPPORT)	+= $(DRIVERS_SRC)/monitor/mon_vectors.o
